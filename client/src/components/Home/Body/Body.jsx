            ...
            <div className="bg-black">
                ...
                <div className={`absolute inset-0 ${theme === "light" ? "background" : "background"}`}>
                    ...
                    <div className="center flex-col gap-8 sm:gap-2 md:mt-11 sm:mt-6">
                        <h1 className={`text-2xl md:text-5xl lg:text-6xl xl:text-6xl ${theme === "light" ? "text-white" : "text-black"} font-extrabold mt-5 md:mt-24 lg:mt-28 xl:mt-36 tracking-wider text-center`}>
