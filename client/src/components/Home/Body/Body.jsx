    ...
    return (
        <div>
            ...
            <Fade direction='down' delay={0.2}>                    
                <h1 className="text-6xl font-gelasio font-semibold leading-normal text-primary">FAQ's</h1> 
            </Fade>
            </div>                   
