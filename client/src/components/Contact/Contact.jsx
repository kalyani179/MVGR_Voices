...
const Contact = () => {
    return (
        ...
        {/* <video autoPlay loop muted className="w-full h-screen object-cover">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-90 opacity-90">
                <div className="center flex-col gap-5 pt-10">
                    ...
                    <p className="text-white text-xl font-medium w-[60%] sm:w-[95%] sm:text-lg text-center tracking-wide">Reach out to us for inquiries, collaborations, or to share your thoughts. We're here to listen and engage with our community.</p>
                </div>
