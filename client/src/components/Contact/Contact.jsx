    ...
    return (
        ...
        {/* <video autoPlay loop muted className="w-full h-screen object-cover">
            ...
            <div className={`absolute inset-0 ${theme==="light" ? "bg-black" : "bg-white" } bg-opacity-90 ${theme==="light" ? "opacity-85" : "opacity-95"}`}>
                ...
                <div className="center flex-col gap-5 mt-2">
                    <h1 className="text-primary text-4xl font-extrabold font-gelasio tracking-wide">CONTACT US</h1>
                    <p className={`${theme==="light" ? "text-white" : "text-black"} text-lg font-medium w-[60%] sm:w-[95%] sm:text-lg text-center tracking-wide`}>Reach out to us for inquiries, collaborations, or to share your thoughts. We're here to listen and engage with our community.</p>
                </div>
                <div className="flex center justify-around sm:flex-col mt-10 m-20">
