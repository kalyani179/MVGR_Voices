...
const BlogPostCard = ({content,author}) => {
    ...
    return (
            <Link to={`/blog/${id}`} className="bg-white shadow-md flex gap-8 items-center border-b border-grey pb-5 mb-4 hover:shadow-2xl transition duration-300 ease-in-out">
