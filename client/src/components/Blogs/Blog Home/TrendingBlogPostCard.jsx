...
const TrendingBlogPostCard = ({blog,index}) => {
    ...
    return (
        <Link to={`/blog/${id}`} className="flex gap-5 mb-8">
            ...
            <div className="aspect-square w-72 h-[370px] bg-white shadow-md hover:transform hover:shadow-2xl hover:shadow-black/50 transition duration-300 ease-in-out">
